...
class Sanatorium:  # Общие сведения о санаториуме
    def __init__(
        self, id: int, name: str, budget: int, region: str, tags: list, food: str, rating: float
    ):
        self.id = id
        self.name = name
...
class Review:
    def __init__(
        self, id: int, user_id: int, sanatorium_id: int, text: str, rating: float, created_at: str
    ):
        self.id = id
        self.user_id = user_id
...
class RecommendationCalculated:
